 ...
 *   <dd>The optional name of the tooblar, this action is going to be added to later. Note, that
 *   it isn't added automatically, when this action is created. Default: null.</dd>
 *   
 *   <dt><code class="signature">onExecute:function</code></dt>
 *   <dd>The (optional) function which is called when the action is executed. Default: null.</dd>
 *
 *   <dt><code class="signature">onInitEnabled:function</code></dt>
 *   <dd>The (optional) function which is called when the <em>enabled</em> state of the function
 *   is evaluated the first time. Default: null.</dd>
 *   
 *   <dt><code class="signature">onUpdateEnabled:function</code></dt>
 *   <dd>The (optional) function which is called when the <em>enabled</em> state of the function
 *   is reevaluated, in particular, when layer change events or selection change events occur. Default: null.</dd>
 * </dl>
 * 
 * @example
