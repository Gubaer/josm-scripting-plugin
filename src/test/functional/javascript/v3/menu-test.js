...
import * as ut from 'josm/unittest'
...
function createActionTests () {
  ...
  const _a1 = new JSAction({
    name: 'My Action'
  })

  // we can create a more elaborate action
  const _a2 = new JSAction({
    name: 'My Action',
