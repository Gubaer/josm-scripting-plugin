...
class JOSMFixtureBasedTest extends GroovyTestCase {
    ...
    // Note: can't lookup the scripting.jar file generated by the JOSM gradle
    // plugin in 'build/dist/scripting.jar'. In this .jar file the MANIFEST entry
    // is at the end of the .jar file => JOSMs PluginInformation can't extract
    // the MANIFEST. For JarFile::getManifest() to work the MANIFEST entry has
    // to be at the beginning of the jar file?
    @BeforeAll
