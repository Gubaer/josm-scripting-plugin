package org.openstreetmap.josm.plugins.scripting.ui.preferences.common;
...
import static org.openstreetmap.josm.plugins.scripting.ui.preferences.common.IconUtil.saveImageGet;
...
public class ImportPathsEditorPanel extends JPanel {
    ...
    private class AddAction extends AbstractAction {
        ...
        public AddAction() {
            ...
            putValue(Action.SMALL_ICON, IconUtil.saveImageGet("dialogs", "add"));
        }
        @Override
    ...
    private class RemoveAction extends AbstractAction implements ListSelectionListener {
        ...
        public RemoveAction() {
            ...
            putValue(Action.SMALL_ICON, IconUtil.saveImageGet("dialogs", "delete"));
            updateEnabledState();
        }
    ...
    private class UpAction extends AbstractAction implements ListSelectionListener {
        ...
        public UpAction() {
            ...
            putValue(Action.SMALL_ICON, IconUtil.saveImageGet("dialogs/conflict", "moveup"));
            updateEnabledState();
        }
    ...
    private class DownAction extends AbstractAction implements ListSelectionListener {
        ...
        public DownAction() {
            ...
            putValue(Action.SMALL_ICON, IconUtil.saveImageGet("dialogs", "movedown"));
            updateEnabledState();
        }
        @Override
        public void actionPerformed(ActionEvent arg0) {
