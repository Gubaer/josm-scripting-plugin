...
The scripting context persists between script runs. Global side effects &ndash; registered
listeners, open dialogs &ndash; survive until you explicitly clean them up or reset the context.
Use the [josm/context] module to register cleanup callbacks that run automatically before the
context is discarded. See [Managing the scripting context] for details.
...
[Managing the scripting context]: context-lifecycle.html